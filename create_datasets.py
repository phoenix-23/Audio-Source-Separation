...
np.save(dir+"train_input_data", train_input_data)
np.save(dir+"test_input_data", test_input_data)
np.save(dir+"train_output_data", train_output_data)
np.save(dir+"test_output_data", test_output_data)